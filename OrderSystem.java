...
public class OrderSystem extends Application {
	public void start(Stage welcomeStage) throws Exception {
		...
		Label welcomeLabel = new Label("Welcome to The Pizza Palace!");
		welcomeLabel.setFont(new Font("Algerian", 25));
		welcomeLabel.setTextFill(Color.web("#FF4500"));
		ImageView pizzaImageView = new ImageView("pizza.png");
		pizzaImageView.setFitHeight(350);
		pizzaImageView.setFitWidth(350);
		Button startButton = new Button("Start Your Order");
